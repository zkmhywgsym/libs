...
public final class CameraManager {
	...
	private static boolean isLandScope = true;
	/**
	...
	public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
		...
		case PixelFormat.YCbCr_422_SP:
			return new PlanarYUVLuminanceSource(data, width, height, rect.left,
					rect.top, rect.width(), rect.height(), isLandScope);
		default:
			...
			if ("yuv420p".equals(previewFormatString)) {
				return new PlanarYUVLuminanceSource(data, width, height,
						rect.left, rect.top, rect.width(), rect.height(), isLandScope);
			}
		}
	...
	public static boolean isLandScope() {
		return isLandScope;
	}

	public static void setLandScope(boolean isLandScope) {
		CameraManager.isLandScope = isLandScope;
	}
}
