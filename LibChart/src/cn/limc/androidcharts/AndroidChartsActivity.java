...
//		X坐标
		...
		gridchart.setAxisXColor(Color.LTGRAY);//X坐标颜色
		gridchart.setAxisYColor(Color.LTGRAY);//Y坐标颜色
		gridchart.setBorderColor(Color.LTGRAY);//边框坐标颜色
//		gridchart.setLatitudeNum(5);//纵坐标数
//		gridchart.setLongitudeNum(6);//横坐标数
		...
		gridchart.setAxisYTitleQuadrantWidth(50);//纵坐标区域宽
		gridchart.setAxisXTitleQuadrantHeight(20);//横坐标区域高
		gridchart.setAxisXPosition(GridChart.AXIS_X_POSITION_BOTTOM);//横坐标位置
		gridchart.setAxisYPosition(GridChart.AXIS_Y_POSITION_RIGHT);//纵坐标位置
		gridchart.setLatitudeTitles(ytitle);//Y坐标值
		gridchart.setLongitudeTitles(xtitle);//X坐标值
		gridchart.setLongitudeFontSize(14);//横坐标字体大小
		gridchart.setLatitudeFontSize(14);//纵坐标字体大小
		gridchart.setLongitudeFontColor(Color.WHITE);//横坐标字体颜色
		gridchart.setLatitudeColor(Color.GRAY);//横网络颜色
		gridchart.setLatitudeFontColor(Color.WHITE);//纵坐标字体颜色
		gridchart.setLongitudeColor(Color.GRAY);//纵网络颜色
		gridchart.setDisplayLongitudeTitle(true);//是否显示横坐标
		gridchart.setDisplayLatitudeTitle(true);//是否显示纵坐标
		gridchart.setDisplayLatitude(true);//是否显示横网络
		gridchart.setDisplayLongitude(true);//是否显示纵网络
		gridchart.setCrossLinesColor(Color.BLUE);//触点线颜色
		gridchart.setCrossLinesFontColor(Color.GREEN);//触点坐标字体颜色
		gridchart.setBorderWidth(1);//边框线宽度
		gridchart.setAxisWidth(1);//轴线宽度
	}
	/**初始化线图*/
